...
*This is an autogenerated Etsy Java client based on the Open API spec provided by Esty.*

*The client was built on 2022-05-07 and reflects the Open API spec at that time.*

Below is the documentation provided by Etsy and the auto code geneneration.

At the moment the jar files from this project are not in any public maven repo, please download them from the *Releases* here on GitHub.
