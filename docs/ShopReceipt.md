...
**receiptType** | **Integer** | The numeric value for the Etsy channel that serviced the purchase: 0 for Etsy.com, 1 for a Pattern shop. | 
**sellerUserId** | **Integer** | The numeric ID for the [user](/documentation/reference#tag/User) (seller) fulfilling the purchase. | 
**sellerEmail** | **String** | The email address string for the seller of the listing. | 
**buyerUserId** | **Integer** | The numeric ID for the [user](/documentation/reference#tag/User) making the purchase. | 
...
**createTimestamp** | **Integer** | The receipt\\&#39;s creation time, in epoch seconds. | 
**updateTimestamp** | **Integer** | The time of the last update to the receipt, in epoch seconds. | 
