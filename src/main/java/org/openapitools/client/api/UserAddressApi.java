...
public class UserAddressApi {
     ...
     */
    public okhttp3.Call getUserAddressCall(Integer userAddressId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getUserAddressValidateBeforeCall(Integer userAddressId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public UserAddress getUserAddress(Integer userAddressId) throws ApiException {
     ...
     */
    public ApiResponse<UserAddress> getUserAddressWithHttpInfo(Integer userAddressId) throws ApiException {
     ...
     */
    public okhttp3.Call getUserAddressAsync(Integer userAddressId, final ApiCallback<UserAddress> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getUserAddressesCall(Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserAddressesValidateBeforeCall(Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
     ...
     */
    public UserAddresses getUserAddresses(Integer limit, Integer offset) throws ApiException {
     ...
     */
    public ApiResponse<UserAddresses> getUserAddressesWithHttpInfo(Integer limit, Integer offset) throws ApiException {
     ...
     */
    public okhttp3.Call getUserAddressesAsync(Integer limit, Integer offset, final ApiCallback<UserAddresses> _callback) throws ApiException {
