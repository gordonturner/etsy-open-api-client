 ...
 */
@ApiModel(description = "Represents a list of listing image resources, each of which contains the reference URLs and metadata for an image.")
...
public class ListingImages {
  ...
  private List<ListingImage> results = new ArrayList<ListingImage>();

  public ListingImages() { 
  }

  public ListingImages count(Integer count) {
  ...
  **/
  ...
  public ListingImages results(List<ListingImage> results) {
    
    this.results = results;
    return this;
  }

  public ListingImages addResultsItem(ListingImage resultsItem) {
