...
public class Money {
  ...
  **/
  ...
  @ApiModelProperty(value = "The amount of represented by this data.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The divisor to render the amount.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The ISO currency code for this data.")
