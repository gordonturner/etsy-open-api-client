...
public class Payments {
  ...
  private List<Payment> results = null;
  ...
  **/
  ...
  @ApiModelProperty(value = "The number of payments in the response.")
  ...
  public Payments results(List<Payment> results) {
    
    this.results = results;
    return this;
  }

  public Payments addResultsItem(Payment resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<Payment>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of payments.")
