...
public class ShopProductionPartner {
  ...
  **/
  ...
  @ApiModelProperty(value = "The numeric ID of a production partner.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name or title of the production partner.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A string representing the production partner location.")
