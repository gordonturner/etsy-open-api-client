 ...
 */
@ApiModel(description = "All the sections in a sprecific Shop.")
...
public class ShopSections {
  ...
  private List<ShopSection> results = new ArrayList<ShopSection>();

  public ShopSections() { 
  }

  public ShopSections count(Integer count) {
  ...
  **/
  ...
  public ShopSections results(List<ShopSection> results) {
    
    this.results = results;
    return this;
  }

  public ShopSections addResultsItem(ShopSection resultsItem) {
  ...
  **/
  ...
  public List<ShopSection> getResults() {
    return results;
  }


  public void setResults(List<ShopSection> results) {
    this.results = results;
  }
