 ...
 */
@ApiModel(description = "A set of transaction review records left by Users.")
...
public class TransactionReviews {
  ...
  private List<TransactionReview> results = null;
  ...
  **/
  ...
  @ApiModelProperty(value = "The number of TransactionReview resources found.")
  ...
  public TransactionReviews results(List<TransactionReview> results) {
    
    this.results = results;
    return this;
  }

  public TransactionReviews addResultsItem(TransactionReview resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<TransactionReview>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The TransactionReview resources found.")

  public List<TransactionReview> getResults() {
    return results;
  }


  public void setResults(List<TransactionReview> results) {
    this.results = results;
  }
